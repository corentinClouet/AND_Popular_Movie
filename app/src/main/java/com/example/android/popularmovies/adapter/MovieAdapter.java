...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MovieAdapterViewHolder> {
    ...
    public MovieAdapter(MovieAdapterOnClickHandler clickHandler, Context context) {
        mLstMovie = new ArrayList<>(); //create empty list by default
    ...
    public class MovieAdapterViewHolder extends RecyclerView.ViewHolder implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Movie movie = mLstMovie.get(adapterPosition);
    ...
    public void onBindViewHolder(MovieAdapterViewHolder movieAdapterViewHolder, int position) {
        Movie movie = mLstMovie.get(position);
        ...
        //Picasso.with(mContext).invalidate(movie.getPosterUrl());
        Picasso.with(mContext).load(movie.getPosterUrl()).networkPolicy(NetworkPolicy.NO_CACHE).memoryPolicy(MemoryPolicy.NO_CACHE);
    }
    ...
    public int getItemCount() {
        if (null == mLstMovie) return 0;
        return mLstMovie.size();
    }
